...
class Ui {
     ...
     */
    _addDownloadEvent() {
        this.eventHandler.download = () => this._actions.main.download(this.options.urlToUpload);
    ...
    _addSaveEvent() {
        this.eventHandler.save = () => this._actions.main.save(this.options.urlToUpload);
